...
class ImageMediaType(Enum):
    ...
    MediaTypeDockerSchema2LayerGzip = (
    ...
    MediaTypeContainerd1Checkpoint = (
        "application/vnd.containerd.container.criu.checkpoint.criu.tar"
    )
    MediaTypeContainerd1CheckpointPreDump = (
        "application/vnd.containerd.container.criu.checkpoint.predump.tar"
    )
    MediaTypeContainerd1Resource = "application/vnd.containerd.container.resource.tar"
    MediaTypeContainerd1RW = "application/vnd.containerd.container.rw.tar"
    MediaTypeContainerd1CheckpointConfig = (
        "application/vnd.containerd.container.checkpoint.config.v1+proto"
    )
    MediaTypeContainerd1CheckpointOptions = (
        "application/vnd.containerd.container.checkpoint.options.v1+proto"
    )
    MediaTypeContainerd1CheckpointRuntimeName = (
        "application/vnd.containerd.container.checkpoint.runtime.name"
    )
    ...
    MediaTypeImageLayerEncrypted = (
        V1ImageMediaType.MediaTypeImageLayer.value + "+encrypted"
    )
    MediaTypeImageLayerGzipEncrypted = (
        V1ImageMediaType.MediaTypeImageLayerGzip.value + "+encrypted"
    )
